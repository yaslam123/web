...
const items = [
    ...
    '/assets/images/construction/project2.jpg',
    '/assets/images/construction/project3.jpg',
    '/assets/images/construction/project4.jpg',
    '/assets/images/construction/project5.jpg',
    '/assets/images/construction/project6.jpg',
    '/assets/images/construction/project7.jpg',
];
...
const Construction = () => {
    ...
    return (
        <div>
            <Head>
                <title>Construction | Plurk – Tailwind CSS Multipurpose Landing Templates</title>
            </Head>
            <section className="bg-black bg-[url(/assets/images/construction/banner-frame.png)] bg-bottom bg-no-repeat">
                <div className="container">
                    <div className="flex flex-col items-center gap-10 py-40 lg:flex-row">
                        <div className="text-center text-white ltr:lg:text-left rtl:lg:text-right">
                            <h2 className="text-3xl font-black sm:text-6xl">
                                WE TAKE YOUR <span className="text-primary">DREAM HOME</span> & <span className="text-secondary">MAKE IT REAL</span>
                            </h2>
                            <p className="mt-5 text-lg font-semibold">
                                Nisi nec a enim, velit potenti nunc interdum facilisis Pharetra integer viverra et scelerisque egestas.
                            </p>
                            <Link href="/contact-us" className="btn mt-5 rounded-md bg-white">
                                Contact Us
                            </Link>
                        </div>
                        <div>
            ...
            <section className="bg-[url(/assets/images/construction/services-bg-img.png)] bg-cover bg-center bg-no-repeat py-12 lg:py-24">
                <div className="container">
                    <div className="heading text-center">
                        <h4 className="!font-black">
                            OUR <span className="text-primary">SERVICES</span>
                        </h4>
                        <h6 className="mx-auto mt-2 max-w-[663px] !font-medium !text-gray dark:!text-white">
                    ...
                    <div
                        className="grid grid-cols-1 justify-between gap-10 sm:grid-cols-2 md:gap-16 lg:grid-cols-3"
                        data-aos="fade-up"
                        data-aos-duration="1000"
                    >
                        <div>
                            <span>
                                <svg className="h-[60px] w-[60px]" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_189_777)">
                                        <path
                            ...
                            <Link
                                href="#"
                                className="relative inline-block py-5 text-2xl font-bold text-secondary transition line-clamp-1 hover:text-primary sm:py-8"
                            >
                                Over 15 years experience
                                <span className="absolute top-1/2 -translate-y-1/2 text-[64px] font-extrabold text-black/[0.05] ltr:left-0 rtl:right-0 dark:text-white/[0.05]">
                                    01
                                </span>
                            </Link>
            ...
            <section className="bg-black py-12 dark:bg-gray-dark md:py-[75px]">
                <div className="container">
                    <div className="flex flex-col items-center justify-between gap-7 text-center sm:flex-row ltr:sm:text-left rtl:sm:text-right">
                        <p className="flex-1 text-2xl font-bold text-white md:text-3xl">An innovative company working with the latest technologies</p>
                        <button type="button" className="btn flex-none rounded-md text-white shadow-[10px_15px_30px_rgba(119,128,161,0.2)]">
                            Get A Quote
                        </button>
                    </div>
                </div>
            ...
            <section className="py-12 lg:py-24">
                <div className="container">
                    <div className="heading text-center">
                        <h4 className="!font-black">
                            ULTRA <span className="text-secondary">PERFORMANCE</span>
                        </h4>
                        <h5 className="mx-auto mt-2 max-w-[507px] !font-medium !text-gray dark:!text-white">
                            Proin gravida nibh vel velit auctor aliquet aenean sollicitudin, lorem quis bibendum auctor, nisi elit cuat ipsum.
                        </h5>
                    </div>
                    <div className="grid gap-8 lg:grid-cols-2" data-aos="zoom-in-up" data-aos-duration="1000">
                        <div>
                            <div className="flex items-center justify-between text-black dark:text-white">
                                <p className="text-xl font-bold">BUILDINGS</p>
                                <p className="text-xl font-bold">95%</p>
                            </div>
                            <div className="relative mt-2.5 h-[15px] rounded-[15px] bg-gray/20">
                                <div className="absolute h-[15px] rounded-[15px] bg-primary px-40 sm:px-60"></div>
                            </div>
                        </div>
                        <div>
                            <div className="flex items-center justify-between text-black dark:text-white">
                                <p className="text-xl font-bold">ARCHITECTURE</p>
                                <p className="text-xl font-bold">60%</p>
                            </div>
                            <div className="relative mt-2.5 h-[15px] rounded-[15px] bg-gray/20">
                                <div className="absolute h-[15px] rounded-[15px] bg-primary px-28 sm:px-40"></div>
                            </div>
                        </div>
                        <div>
                            <div className="flex items-center justify-between text-black dark:text-white">
                                <p className="text-xl font-bold">CONSTRUCTIONS</p>
                                <p className="text-xl font-bold">70%</p>
                            </div>
                            <div className="relative mt-2.5 h-[15px] rounded-[15px] bg-gray/20">
                                <div className="absolute h-[15px] rounded-[15px] bg-primary px-32 sm:px-[180px]"></div>
                            </div>
                        </div>
                        <div>
                            <div className="flex items-center justify-between text-black dark:text-white">
                            ...
                            <div className="relative mt-2.5 h-[15px] rounded-[15px] bg-gray/20">
                                <div className="absolute h-[15px] rounded-[15px] bg-primary px-20 sm:px-32"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-white pt-12 dark:bg-gray-dark lg:pt-24">
                <div className="container">
                    <div className="heading text-center">
                        <h4 className="!font-black">
                            SOME OF <span className="text-primary">OUR ESTEEMED PROJECTS</span>
                        </h4>
                        <h6 className="mx-auto mt-2 max-w-[507px] !font-medium !text-gray dark:!text-white">
                            Proin gravida nibh vel velit auctor aliquet aenean sollicitudin, lorem quis bibendum auctor, nisi elit cuat ipsum.
                        </h6>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
                    <div className="group">
                        ...
                        <div className="space-y-2.5 p-3 text-center sm:p-5 ltr:sm:text-left rtl:sm:text-right">
                            <Link
                                href="#"
                                className="text-lg font-bold text-black duration-200 group-hover:text-secondary dark:text-white dark:group-hover:text-secondary md:text-2xl"
                            >
                                The Atmosphere
                            </Link>
                            <p className="text-base font-semibold">Chicago, USA</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="relative overflow-hidden">
                        ...
                        <div className="space-y-2.5 p-3 text-center sm:p-5 ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <p className="text-base font-semibold">Madrid, Spain</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="relative overflow-hidden">
                        ...
                        <div className="space-y-2.5 p-3 text-center sm:p-5 ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <p className="text-base font-semibold">Bali, Indonesia</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="relative overflow-hidden">
                        ...
                        <div className="space-y-2.5 p-3 text-center sm:p-5 ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <p className="text-base font-semibold">Beijing, China</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="relative overflow-hidden">
                        ...
                        <div className="space-y-2.5 p-3 text-center sm:p-5 ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <p className="text-base font-semibold">California, USA</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="relative overflow-hidden">
                        ...
                        <div className="space-y-2.5 p-3 text-center sm:p-5 ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <p className="text-base font-semibold">Moscow, Russia</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="relative overflow-hidden">
                    ...
                    <div className="group">
                        ...
                        <div className="space-y-2.5 p-3 text-center sm:p-5 ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <p className="text-base font-semibold">Auckland, New Zealand</p>
                        </div>
                    </div>
                </div>
            </section>

            <section className="mt-12 bg-black py-[50px] dark:bg-gray-dark lg:mt-24">
                <div className="container">
                    <div className="grid grid-cols-2 justify-between gap-7 text-center sm:grid-cols-4" data-aos="fade-up" data-aos-duration="1000">
                        <div>
                            <div className="text-[40px] font-black leading-[50px] text-white">
                                <CountUp start={0} end={8350} duration={10}></CountUp>
                            </div>
                            <p className="mt-2 text-lg font-semibold">Hours of Works</p>
                        </div>
                        <div>
                            <div className="text-[40px] font-black leading-[50px] text-white">
                                <CountUp start={0} end={240} duration={10}></CountUp>
                            </div>
                            <p className="mt-2 text-lg font-semibold">Projects Complete</p>
                        </div>
                        <div>
                            <div className="text-[40px] font-black leading-[50px] text-white">
                                <CountUp start={0} end={120} duration={10}></CountUp>
                            </div>
                            <p className="mt-2 text-lg font-semibold">Feedback Received</p>
                        </div>
                        <div>
                            <div className="text-[40px] font-black leading-[50px] text-white">
                                <CountUp start={0} end={20} duration={10}></CountUp>
                            </div>
                            <p className="mt-2 text-lg font-semibold">Awards Winning</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 lg:py-24">
                <div className="container">
                    <div className="heading text-center">
                        ...
                        <h6 className="mx-auto mt-[18px] max-w-[663px] !font-medium !text-gray dark:!text-white">
                            Duis sed odio sit amet nibh vulputate cursus a sit amet mauris morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a
                            ornare odio.
                        </h6>
                    </div>
            ...
            <section className="bg-black/[0.05] py-12 dark:bg-gray-dark lg:py-24">
                <div className="container">
            ...
            <section className="overflow-hidden py-12 lg:py-24">
                <div className="container">
                    <div className="heading text-center">
                        <h4 className="!font-black">
                            RECENT <span className="text-secondary">NEWS</span>
                        </h4>
                        <h5 className="mt-2 !font-medium !text-gray dark:!text-white">Check out our latest blog posts</h5>
                    </div>
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3" data-aos="fade-up" data-aos-duration="1000">
                        <div className="group relative overflow-hidden rounded-xl border-2 border-transparent duration-200 hover:border-secondary">
                            ...
                            <div className="space-y-[14px] bg-white px-4 py-5 group-hover:bg-secondary/20 dark:bg-gray-dark">
                                ...
                                <p className="text-base font-medium">Lorem ipsum dolor amet consectetur adipisicing elit eiusm tempor incididunt...</p>
                            </div>
                        </div>
                        <div className="group relative overflow-hidden rounded-xl border-2 border-transparent duration-200 hover:border-secondary">
                            <Link href="#" className="absolute inset-0 h-full w-full"></Link>
            ...
            <section className="dark:bg-gray-dark">
                <Testimonial className="relative py-14 lg:py-[100px]" feedbacks={feedbacks} />
            </section>
