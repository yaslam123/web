...
const Blog2 = () => {
    ...
    return (
        <div>
            ...
            <section className="bg-black bg-[url(/assets/images/blog/banner_bg.png)] bg-center bg-no-repeat pb-12 pt-36 text-white sm:pt-[200px] lg:pb-80">
                    ...
                    <div className="relative">
                        <div className="text-center lg:max-w-[754px] ltr:lg:text-left rtl:lg:text-right">
                            ...
                            <div className="mt-10 flex items-center justify-center gap-6 lg:justify-start">
                                <button type="button" className="btn bg-white py-[19px] shadow-[10px_15px_30px_rgba(199,128,161,0.2)]">
                                    All Postsa
                                </button>
                                <button type="button" className="btn py-[19px] px-8 text-white shadow-[10px_15px_30px_rgba(199,128,161,0.2)]">
                                    Trending
                                </button>
                            </div>
                        </div>
            ...
            <section className="py-12 lg:py-24">
                <div className="container">
                    <div className="flex items-center gap-3">
                        <div className="h-[30px] w-[5px] bg-secondary"></div>
                        <h5 className="text-2xl font-extrabold text-black dark:text-white">Trending</h5>
                    </div>
                    <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2" data-aos="flip-left" data-aos-duration="1000">
                        <div className="group relative h-[300px] flex-1 overflow-hidden rounded-[10px] sm:h-auto">
                            ...
                            <img
                                ...
                                alt=""
                            />
                            <h5 className="absolute top-5 rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold text-white ltr:left-5 rtl:right-5">TECH</h5>
                        ...
                        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div className="group relative h-[263px] w-full overflow-hidden rounded-[10px] lg:max-w-[263px]">
                                ...
                                <div className="absolute bottom-4 left-5 right-5 z-[1] text-white">
                                    <Link href="#" className="text-[19px] font-bold duration-200 hover:text-secondary dark:hover:text-secondary">
                            ...
                            <div className="group relative h-[263px] w-full overflow-hidden rounded-[10px] lg:max-w-[263px]">
                                ...
                                <div className="absolute bottom-4 left-5 right-5 z-[1] text-white">
                                    <Link href="#" className="text-[19px] font-bold duration-200 hover:text-secondary dark:hover:text-secondary">
                                        Park’s Shinoda says ‘no way’ to a hologram Chester Bennington{' '}
                                    </Link>
                                    <div className="mt-[14px] flex items-center gap-2">
                                        <span>
                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="bg-gradient-to-b from-white/60 to-transparent py-12 dark:bg-gradient-to-b dark:from-white/10 dark:to-transparent lg:py-24">
                <div className="container">
                    <div className="mb-5 flex justify-between">
                        <div className="flex items-center gap-3">
                            <div className="h-[30px] w-[5px] bg-primary"></div>
                            <h5 className="text-2xl font-extrabold text-black dark:text-white">More Stories</h5>
                        </div>
                        <div className="flex gap-[14px]">
                            <button
                                type="button"
                                className="Stories-slider-button-prev flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white"
                            >
                            ...
                            <button
                                type="button"
                                className="Stories-slider-button-next flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white"
                            >
                                <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div className="rounded-[10px] border border-[#BBBBBB]/50 p-3 dark:border-[#7780A1]/20 sm:p-5">
                        <Swiper
                            loop={true}
                            slidesPerView="auto"
                            spaceBetween={30}
                                    ...
                                    <div className="absolute bottom-5 ltr:left-5 rtl:right-5">
                                        ...
                                        <div className="mt-[14px] flex gap-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <p className="text-[13px] font-semibold text-white">20 May 2022</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="relative bg-black py-12 dark:bg-[#1C2331] lg:py-24">
                <div className="absolute inset-0 bg-[url(/assets/images/blog/newsletter.svg)] bg-center bg-repeat opacity-50"></div>
                <div className="container">
                    <div className="relative z-[1] flex flex-col items-center justify-between gap-5 text-center lg:flex-row ltr:lg:text-left rtl:lg:text-right">
                        <div>
                            <h2 className="text-3xl font-extrabold text-primary sm:text-[40px] sm:leading-[50px]">JOIN OUR NEWSLETTER!</h2>
                            <p className="mt-2.5 text-xl font-semibold text-white">Enter your email to receive our newsletter.</p>
                            <div className="relative mx-auto mt-10 lg:mx-0">
                                <input
                                    type="email"
                                    placeholder="example@gmail.com*"
                                    className="relative w-full border border-white bg-transparent py-[18px] text-base font-semibold !text-white outline-none ltr:pl-4 ltr:pr-36 rtl:pr-4 rtl:pl-36"
                                />
                                <button
                                    type="button"
                                    className="absolute top-1/2 -translate-y-1/2 bg-secondary py-3 px-8 text-sm font-extrabold text-white duration-200 hover:bg-primary ltr:right-2 rtl:left-2"
                                >
                                    SUBMIT
                                </button>
                            </div>
            ...
            <section className="bg-gradient-to-b from-white/60 to-transparent py-12 dark:bg-none lg:py-24">
                <div className="container">
                    <div className="mb-9 flex justify-between">
                        <div className="flex items-center gap-3">
                            <div className="h-[30px] w-[5px] bg-secondary"></div>
                            <h5 className="text-2xl font-extrabold text-black dark:text-white">Celebration</h5>
                        </div>
                        <div className="flex gap-[14px]">
                            <button
                                type="button"
                                className="feedback-slider-button-prev flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white"
                            >
                                <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M5.95007 1.20007L1.48924 5.34228C1.06317 5.73791 1.06317 6.41223 1.48924 6.80787L5.95007 10.9501"
                            ...
                            <button
                                type="button"
                                className="feedback-slider-button-next flex h-[30px] w-[30px] items-center justify-center rounded-full bg-black/[0.04] text-[#08111F] duration-200 hover:bg-black hover:text-white rtl:rotate-y-180 dark:bg-white/[0.04] dark:text-white dark:hover:bg-secondary dark:hover:text-white"
                            >
                                <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M1.05011 10.7999L5.51095 6.65772C5.93701 6.26209 5.93701 5.58777 5.51095 5.19213L1.05011 1.04993"
                    ...
                    >
                        <SwiperSlide>
                            ...
                            <div>
                                ...
                                <Link
                                    href="#"
                                    className="text-lg font-extrabold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                >
                                    Secrets Your Parents Never Told You About Bulb
                                </Link>
                            </div>
            ...
            <section className="mb-12 dark:bg-none sm:p-5 lg:mb-24">
                <div className="mx-auto max-w-[1440px] bg-black py-12 dark:bg-gray-dark sm:rounded-[32px] lg:py-24">
                    <div className="container">
                        <div className="flex flex-col gap-6 lg:flex-row" data-aos="fade-up" data-aos-duration="1000">
                            <div className="flex-1">
                                <div className="mb-5 flex gap-3">
                                    <div className="h-[30px] w-[5px] bg-secondary"></div>
                                    <h5 className="text-2xl font-extrabold text-white">Most Recent</h5>
                                </div>
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    <div className="relative overflow-hidden rounded-[10px]">
                                        ...
                                        <div className="bg-white p-3">
                                            <Link
                                                href="#"
                                                className="text-xl font-bold text-black duration-200 line-clamp-2 hover:text-secondary dark:hover:text-secondary"
                                            >
                                                Still Standing Tall
                                            </Link>
                                            <p className="mt-2 mb-3 text-sm font-medium line-clamp-2">Life begins at the end of your at comfort zone.</p>
                                            ...
                                            <div className="mt-2 flex justify-between">
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <p className="text-[13px] font-semibold">17 Jan 2023</p>
                                                </div>
                                            </div>
                                            <p className="absolute top-5 rounded bg-secondary px-2.5 py-1 text-[12px] font-extrabold leading-4 text-white ltr:left-5 rtl:right-5">
                                                NATURA
                                            </p>
                                        </div>
                                    </div>
                                    <div className="relative overflow-hidden rounded-[10px]">
                                        ...
                                        <div className="bg-white p-3">
                                            ...
                                            <p className="mt-2 mb-3 text-sm font-medium line-clamp-2">
                                            ...
                                            <div className="mt-2 flex justify-between">
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <p className="text-[13px] font-semibold">08 Jan 2023</p>
                                                </div>
                                            </div>
                                            <p className="absolute top-5 rounded bg-primary px-2.5 py-1 text-[12px] font-extrabold leading-4 text-white ltr:left-5 rtl:right-5">
                                                PHOTOGRAPHY
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div className="bg-white p-3">
                                            ...
                                            <div className="mt-2 flex justify-between">
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <p className="text-[13px] font-semibold">13 Mar 2023</p>
                                                </div>
                                            </div>
                                            <p className="absolute top-5 rounded bg-secondary px-2.5 py-1 text-[12px] font-extrabold leading-4 text-white ltr:left-5 rtl:right-5">
                                                VACATION
                                        ...
                                        <div className="bg-white p-3">
                                            ...
                                            <div className="mt-2 flex justify-between">
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <p className="text-[13px] font-semibold">11 Feb 2023</p>
                                                </div>
                                            </div>
                                            <p className="absolute top-5 rounded bg-primary px-2.5 py-1 text-[12px] font-extrabold leading-4 text-white ltr:left-5 rtl:right-5">
                                                VACATION
                            ...
                            <div className="flex-none lg:w-[470px]">
                                <div className="mb-5 flex gap-3">
                                    <div className="h-[30px] w-[5px] bg-primary"></div>
                                    <h5 className="text-2xl font-extrabold text-white">Featured Posts</h5>
                                </div>
                                <div className="space-y-6">
                                    <div className="relative h-[306px] w-full overflow-hidden rounded-[10px]">
                                        ...
                                        <div className="absolute bottom-5 left-5 right-5">
                                            ...
                                            <p className="mt-2 text-sm font-medium text-white">The road ahead might be paved - it might not be.</p>
                                            ...
                                            <div className="mt-3 flex justify-between">
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <p className="text-sm font-semibold text-white">05 Sep 2022</p>
                                                </div>
                                            </div>
                                        </div>
                                        <p className="absolute top-5 rounded bg-secondary py-1 px-2.5 text-[12px] font-extrabold leading-4 text-white ltr:left-5 rtl:right-5">
                                            PHOTOGRAPHY
                                        </p>
                                    </div>
                                    <div className="relative h-[306px] overflow-hidden rounded-[10px]">
                                        ...
                                        <div className="absolute bottom-5 left-5 right-5">
                                            ...
                                            <p className="mt-2 text-sm font-medium text-white">Once a year, go someplace you’ve never been before.</p>
                                            <div className="mt-3 border-b border-white/40"></div>
                                            <div className="mt-3 flex justify-between">
                                                <div className="flex items-center gap-2.5">
                                                    <img src="/assets/images/blog/william1.png" alt="" />
                                                ...
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <p className="text-sm font-semibold text-white">07 Sep 2022</p>
                                                </div>
                                            </div>
                                        </div>
                                        <p className="absolute top-5 rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold leading-4 text-white ltr:left-5 rtl:right-5">
                                            ADVENTURE
                                        </p>
                                    </div>
                                </div>
            ...
            <section className="bg-white py-6 dark:bg-[#1C2331]">
                <div className="container">
                    <div className="grid grid-cols-2 justify-center gap-7 text-center md:grid-cols-4">
                        <div>
                            <span>
                                <svg className="mx-auto h-12 w-12" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div className="mt-5 text-[34px] font-black leading-10 text-black dark:text-white">
                                <CountUp start={0} end={60} duration={10} suffix="+"></CountUp>
                            </div>
                            <p className="mt-2.5 text-base font-bold">Unique content blocks</p>
                        </div>
                        <div>
                            <span>
                                <svg className="mx-auto h-12 w-12" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <p className="mt-2.5 text-base font-bold">Positive feedback</p>
                        </div>
                        <div>
                            <span>
                                <svg className="mx-auto h-12 w-12" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        ...
                                        strokeLinecap="round"
                                    />
                                    <path d="M45.8333 32.2916V36.4583" stroke="#B476E5" strokeWidth="3" strokeLinecap="round" />
                                    <path d="M4.16667 32.2916V36.4583" stroke="#B476E5" strokeWidth="3" strokeLinecap="round" />
                                    <path
                            ...
                            <div className="mt-5 text-[34px] font-black leading-10 text-black dark:text-white">
                                <CountUp start={0} end={24} duration={10} suffix="hours"></CountUp>
                            </div>
                            <p className="mt-2.5 text-base font-bold">Average support time</p>
                        </div>
                        <div>
                            <span>
                                <svg className="mx-auto h-12 w-12" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="mt-2.5 text-base font-bold">Visitor return rate</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row">
                        <div className="space-y-5 lg:max-w-[650px] xl:max-w-[726px]">
                            <div className="item-center flex gap-2.5">
                                <div className="h-[30px] w-[5px] bg-secondary"></div>
                                <div>
                                    <p className="text-2xl font-extrabold text-black dark:text-white">Random Posts</p>
                                </div>
                            </div>
                            <div className="mt-5 flex flex-col gap-6 sm:flex-row">
                                ...
                                <div>
                                    <div className="mb-[14px]">
                                        <p className="inline-block rounded bg-secondary py-1 px-2.5 text-[12px] font-extrabold leading-4 text-white">
                                            Photographs
                                        </p>
                                    </div>
                                    <Link
                                    ...
                                    <p className="mt-3 text-sm font-medium">
                                        Tincidunt dolor neque, risus aliquet ac cursus sodales placerat. Elit, nisl convallis diam imperdiet feugiat. Sagittis,
                                        neque commodo.
                                    </p>
                                </div>
                            </div>
                            <div className="flex flex-col gap-6 sm:flex-row">
                                ...
                                <div>
                                    <div className="mb-[14px]">
                                        <p className="inline-block rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold leading-4 text-white">DESIGN</p>
                                    </div>
                                    <Link
                                        href="#"
                                        className="mt-3 text-xl font-bold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                    ...
                                    <p className="mt-3 text-sm font-medium">
                                        Turpis pulvinar quam nec porta faucibus blandit nulla diam ut. Nisi, amet sit vitae mattis. Dictum enim dictum quam
                                        pretium pretium.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="item-center flex gap-2.5">
                                <div className="h-[30px] w-[5px] bg-primary"></div>
                                <div>
                                    <p className="text-2xl font-extrabold text-black dark:text-white">Latest Videos</p>
                                </div>
                            </div>
                            <div className="mt-5 mb-5 flex gap-3">
                                <div className="relative max-w-[165px] overflow-hidden rounded-[10px]">
                                    ...
                                    >
                                        <svg className="h-3 w-3" viewBox="0 0 666 731" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div>
                                    ...
                                    <Link
                                        href="#"
                                        className="text-base font-bold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                    >
                                        Julie Chair A Modern Durable Plastic ALMA Design Chair
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="mt-5 mb-5 flex gap-3">
                                ...
                                <div>
                                    <div className="mb-3">
                                        <p className="inline-block rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold leading-4 text-white">CARS</p>
                                    </div>
                                    <Link
                                        href="#"
                            ...
                            <div className="mt-5 flex gap-3">
                                ...
                                <div>
                                    ...
                                    <Link
                                        ...
                                        className="text-base font-bold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                    >
                                        Ultra by Ultra Is A Ultimate Minimalist Wallet Solution.
                                    </Link>
                                </div>
                            </div>
                        </div>
