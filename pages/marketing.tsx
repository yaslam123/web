...
const Marketing = () => {
    ...
    return (
        <div className="overflow-x-hidden">
            <Head>
                <title>Marketing | Plurk – Tailwind CSS Multipurpose Landing Templates</title>
            </Head>
                    ...
                    <div className="flex flex-col items-center gap-7 lg:flex-row">
                        <div className="flex-1 pb-14 pt-14 text-white ltr:text-center rtl:text-center lg:max-w-[558px] lg:pb-52 ltr:lg:text-left rtl:lg:text-right xl:pt-36">
                            <h2 className="text-3xl font-extrabold sm:text-5xl lg:text-[70px] lg:leading-[89px]">
                                We take <span className="text-secondary">care</span> of your
                        ...
                        <div className="mb-10 w-full max-w-[500px] flex-none lg:mb-0" data-aos="fade-left" data-aos-duration="1000">
                            <img src="/assets/images/marketing/marketing-banner.png" className="rtl:rotate-y-180 xl:ml-[100px]" alt="" />
                        </div>
                    </div>
                </div>
            </div>

            <section className="py-14 pb-12 lg:py-20">
                ...
                <div className="container">
                    ...
                    >
                        <div className="group relative rounded-3xl border-2 border-transparent bg-white p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                            ...
                            <h3 className="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">SEO Optimization</h3>
                            <p className="text=lg mt-4 font-semibold text-gray dark:group-hover:text-black">
                                We implement the best SEO strategies that helps you reach interested customers on a global scale, thus helping you achieve more
                                online presence.
                            </p>
                            <Link
                        ...
                        <div className="group relative rounded-3xl border-2 border-transparent bg-white p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                            ...
                            <h3 className="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">Growth rating</h3>
                            <p className="text=lg mt-4 font-semibold text-gray dark:group-hover:text-black">
                                Our one of most valuable service is this, growth your business through digital marketing & advertising. Move forward your
                                business with growth rating.
                            </p>
                            <Link
                                href="/services-detail"
                                className="mt-6 flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black group-hover:text-white ltr:float-right rtl:float-left dark:bg-gray-dark"
                        ...
                        <div className="group relative rounded-3xl border-2 border-transparent bg-white p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary sm:!mt-10 lg:!mt-0">
                            ...
                            <h3 className="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">Content Marketing</h3>
                            <p className="text=lg mt-4 font-semibold text-gray dark:group-hover:text-black">
                                You want to create content that helps them make better decisions and that establishes your business as THE authority in the
                                process. Do it right & get your result.
                            </p>
                            <Link
                                href="/services-detail"
                                className="mt-6 flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black group-hover:text-white ltr:float-right rtl:float-left dark:bg-gray-dark"
            ...
            <section className="bg-[url(/assets/images/marketing/business-owner.jpg)] bg-cover bg-center bg-no-repeat py-14 lg:py-[100px]">
                <div className="container relative">
                    <div className="heading text-center">
                        <h6 className="!text-secondary">Who we are</h6>
                        <h4 className="!text-white">
                            Our commitments to <span className="text-primary">business</span> owner
                        </h4>
                    </div>
                    ...
                    <div className="mx-auto grid max-w-[250px] gap-[30px] ltr:text-right rtl:text-left sm:max-w-none sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <span className="font-semibold text-white transition group-hover:text-black">Year in Business</span>
                            </div>
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <span className="font-bold text-white transition group-hover:text-black">Team Members</span>
                            </div>
                            <div className="shrink-0 text-[#47BDFF] group-hover:text-black">
                                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <span className="font-bold text-white transition group-hover:text-black">Happy Clients</span>
                            </div>
                            <div className="shrink-0 text-[#47BDFF] group-hover:text-black">
                                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            <div className="flex-1">
                                <div className="pb-2.5 text-4xl font-black leading-none transition group-hover:text-black">
                                    <CountUp start={0} end={1384} duration={4} suffix="+"></CountUp>
                                </div>
                ...
                <div className="container">
                    <div className="flex flex-col items-center gap-[30px] lg:flex-row">
                        <div className="w-full max-w-[484px]">
                            <img src="/assets/images/marketing/work-img.png" className="rtl:rotate-y-180" alt="" />
                        </div>
                        <div>
                            ...
                            <div className="mt-12 grid grid-cols-3 space-y-7 text-center">
                                <div className="col-span-3 flex">
                                    <div>
                                        <h2 className="text-[70px] font-black leading-[57px] text-secondary">1</h2>
                                        <p className="mt-1 text-2xl font-bold">Project Idea</p>
                                    </div>
                                </div>
                                <div className="col-span-3">
                                    <h2 className="text-[70px] font-black leading-[57px] text-primary">2</h2>
                                    <p className="mt-1 text-2xl font-bold">Marketing Plan</p>
                                </div>
                                <div className="col-span-3 flex justify-end">
                                    <div className="relative">
                                        <span className="absolute inset-x-0 -top-12">
                                            <img src="/assets/images/marketing/shadow-box.svg" alt="" />
                                        </span>
                                        <h2 className="text-[70px] font-black leading-[57px] text-secondary">3</h2>
                                        <p className="mt-1 text-2xl font-bold">Growth & Scale</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="bg-gradient-to-t from-transparent to-white/[55%] pt-10 dark:bg-gradient-to-b dark:from-white/5 dark:to-transparent lg:py-20">
                <div className="container">
                ...
                <div className="container relative px-16">
                    ...
                    >
                        ...
                        <SwiperSlide className="relative text-center">
                            ...
                            <h3 className="mt-2 text-xl font-extrabold text-black dark:text-white">Miranda Summers</h3>
                            <p className="mt-2.5 text-sm font-semibold">Head of Sales</p>
                        </SwiperSlide>
                ...
                <div className="container">
                    ...
                    >
                        <div className="group relative space-y-6 rounded-[32px] border-2 border-primary bg-white p-7 duration-200 hover:bg-primary hover:text-white dark:border-gray/[0.1] dark:bg-gray-dark dark:hover:border-primary">
                            <div className="item-center absolute -top-[30px] left-1/2 mx-auto inline-flex -translate-x-1/2 justify-between rounded-[78px] bg-primary py-4 px-8 text-white">
                                <h5 className="text-[22px] font-black">Intro</h5>
                            </div>
                            <div className="mt-14 flex items-center gap-2">
                                ...
                                <div>
                                    <p className="text-sm font-bold">Social Media Marketing</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="text-sm font-bold">SEO: Search Engine Optimization</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div>
                                ...
                                <div>
                                    <p className="text-sm font-bold">Paid Advertising</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div>
                                ...
                                <div>
                                    <p className="text-sm font-bold">Normal Support</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <p className="text-sm font-bold">Conversion Optimization</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div>
                                ...
                                <div>
                                    <p className="text-sm font-bold">Browse with no ads</p>
                                </div>
                            </div>
                            ...
                            <div className="text-center">
                                <button
                                    type="button"
                                    className="btn py-[19px] px-[26px] text-[22px] font-black text-white group-hover:bg-white group-hover:text-primary"
                                >
                                    $39.33<span className="text-sm font-bold">/month</span>
                                </button>
                            </div>
                        ...
                        <div className="group relative space-y-6 rounded-[32px] border-2 border-transparent bg-black p-7 text-white duration-200 hover:border-2 hover:border-black hover:bg-white hover:text-black dark:bg-white/5 dark:hover:border-white dark:hover:text-white">
                            <div className="item-center absolute -top-[30px] left-1/2 mx-auto flex -translate-x-1/2 justify-between rounded-[78px] bg-gray py-4 px-8 text-white">
                                <h5 className="text-[22px] font-black">Base</h5>
                            </div>
                            ...
                            <div className="text-center">
                                <button
                                    type="button"
                                    className="btn bg-white py-[19px] px-[26px] text-[22px] font-black text-black group-hover:bg-black group-hover:text-white"
                                >
                                    $14.99<span className="text-sm font-bold">/month</span>
                                </button>
                            </div>
                            <h5 className="font-blod mt-4 text-center text-sm">Billed every month</h5>
                        </div>
                        <div className="group relative space-y-6 rounded-[32px] border-2 border-secondary bg-white p-7 duration-200 hover:bg-secondary hover:text-white dark:border-gray/[0.1] dark:bg-gray-dark dark:hover:border-secondary">
                            <div className="item-center absolute -top-[30px] left-1/2 mx-auto flex -translate-x-1/2 justify-between rounded-[78px] bg-secondary py-4 px-8 text-white">
                                <h5 className="text-[22px] font-black">Base</h5>
                            </div>
                            <div className="mt-14 flex items-center gap-2">
                                <div>
                            ...
                            <div className="text-center">
                                <button
                                    type="button"
                                    className="btn bg-secondary py-[19px] px-[26px] text-[22px] font-black text-white group-hover:bg-white group-hover:text-secondary"
                                >
                                    $399<span className="text-sm font-bold">/Year</span>
                                </button>
                            </div>
                            <h5 className="font-blod mt-4 text-center text-sm text-black group-hover:text-white">Billed every month</h5>
                        </div>
