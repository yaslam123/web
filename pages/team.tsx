                ...
                <div className="container">
                    ...
                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-5.png"
                                    alt="path-leaders-1"
                        ...
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-6.png"
                                    alt="path-leaders-2"
                                    className="h-full w-full rounded-3xl object-cover object-top"
                                />
                            </div>
                        ...
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-7.png"
                                    alt="path-leaders-3"
                                    className="h-full w-full rounded-3xl object-cover object-top"
                                />
                            </div>
                        ...
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-8.png"
                                    alt="path-leaders-4"
                                    className="h-full w-full rounded-3xl object-cover object-top"
                                />
                            </div>
                        ...
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-9.png"
                                    alt="path-leaders-5"
                                    className="h-full w-full rounded-3xl object-cover object-top"
                                />
                            </div>
                        ...
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-10.png"
                                    alt="path-leaders-6"
                                    className="h-full w-full rounded-3xl object-cover object-top"
                                />
                            </div>
                        ...
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-11.png"
                                    alt="path-leaders-7"
                                    className="h-full w-full rounded-3xl object-cover object-top"
                                />
                            </div>
                        ...
                        <div className="group mt-4 cursor-pointer text-center">
                            <div className="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                                <img
                                    src="/assets/images/leader-12.png"
                                    alt="path-leaders-8"
                                    className="h-full w-full rounded-3xl object-cover object-top"
                                />
                            </div>
