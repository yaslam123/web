...
const items = [
    ...
    { src: '/assets/images/hotel-resort/room3.jpg', type: 'cozy-room' },
    { src: '/assets/images/hotel-resort/room4.jpg', type: 'family-suit' },
    { src: '/assets/images/hotel-resort/room5.jpg', type: 'family-suit' },
    { src: '/assets/images/hotel-resort/room6.jpg', type: 'modern-room' },
];
const HotelResort = () => {
    ...
    const getItems = () => {
        let imgs: any = items || [];
        if (activeTab.toLowerCase() === 'cozy-room') {
            imgs = imgs.map((d: any) => d.src);
            return imgs;
        }
        imgs = imgs.filter((d: any) => d.type.toLowerCase() === activeTab.toLowerCase()) || [];
        if (imgs.length > 0) {
            imgs = imgs.map((d: any) => d.src);
        }
        return imgs;
    ...
    return (
        <div>
            <Head>
                <title>Hotel & Resort | Plurk – Tailwind CSS Multipurpose Landing Templates</title>
            </Head>
            <section className="hotel-resort-banner relative">
                <div className="h-[750px] lg:h-[828px]">
                    <img src="/assets/images/hotel-resort/hotel-banner.jpg" className="h-full w-full object-cover" alt="" />
                </div>
                <div
                    ...
                    <div className="container">
                        <div className="max-w-[624px] text-center ltr:md:text-left rtl:md:text-right">
                            <h2 className="text-4xl font-black sm:text-5xl md:text-[70px] md:leading-[88px]">
                                <span className="text-secondary">Word</span> Best Resort In Wild <span className="text-primary">Nature</span>
                            </h2>
                            <p className="mt-4 text-lg font-semibold">
                                Enjoying the beach and jungle greenry has never been so easy. In our resort, you'll get our great service, friendly staff and
                                great seaside.
                            </p>
                            <button type="button" className="btn mt-8 bg-white py-[19px] px-8 text-black hover:bg-black hover:text-white md:mt-[60px]">
                                BOOK Now
                            </button>
                        </div>
                    </div>
            ...
            <section className="relative py-12 lg:py-24">
                <img src="/assets/images/hotel-resort/services1.svg" className="absolute bottom-0 ltr:left-0 rtl:right-0 rtl:rotate-y-180" alt="" />
                <img src="/assets/images/hotel-resort/services2.svg" className="absolute bottom-0 ltr:right-0 rtl:left-0 rtl:rotate-y-180" alt="" />
                <div className="container relative">
                    <div className="heading text-center">
                        <h4 className="!text-primary">Facilities & Services</h4>
                        <p className="mt-2.5 text-base font-semibold">With our service you may enjoy the finest life in our resort.</p>
                    </div>
                    <div className="mt-10 grid grid-cols-1 gap-[30px] sm:grid-cols-2 lg:grid-cols-4" data-aos="zoom-in" data-aos-duration="1000">
                        <div className="group rounded-2xl border-2 border-dashed border-gray-dark/20 bg-white p-[30px] pl-5 duration-200 hover:border-secondary hover:bg-secondary/20 dark:border-white/20 dark:bg-gray-dark dark:hover:bg-secondary/20">
                            <span className="flex h-[60px] w-[60px] items-center justify-center rounded-full bg-secondary/10 group-hover:bg-black">
                                <svg width="35" height="26" viewBox="0 0 35 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.5557 24.0002H17.5777" stroke="#B476E5" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                    <path
                                        d="M12.3706 18.8155C13.7458 17.4408 15.6107 16.6685 17.5552 16.6685C19.4997 16.6685 21.3646 17.4408 22.7397 18.8155"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M7.18481 13.6292C8.54672 12.2672 10.1636 11.1868 11.943 10.4497C13.7225 9.71263 15.6297 9.33325 17.5558 9.33325C19.4819 9.33325 21.3891 9.71263 23.1685 10.4497C24.948 11.1868 26.5648 12.2672 27.9267 13.6292"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M2 8.4445C10.5908 -0.148167 24.5202 -0.148167 33.1661 8.4445"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                            ...
                            <h3 className="mt-5 text-xl font-bold text-black dark:text-white">High Speed Wifi</h3>
                            <p className="mt-2.5 text-base font-medium leading-8">Lorem ipsum dolor sit amet consectetur adipiscing elit ugue quam diam.</p>
                        </div>
                        <div className="group rounded-2xl border-2 border-dashed border-gray-dark/20 bg-white p-[30px] pl-5 duration-200 hover:border-secondary hover:bg-secondary/20 dark:border-white/20 dark:bg-gray-dark dark:hover:bg-secondary/20">
                            <span className="flex h-[60px] w-[60px] items-center justify-center rounded-full bg-secondary/10 group-hover:bg-black">
                                <svg width="34" height="26" viewBox="0 0 34 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M8.76865 23.9999C10.6379 23.9999 12.1533 22.4846 12.1533 20.6153C12.1533 18.7461 10.6379 17.2307 8.76865 17.2307C6.89938 17.2307 5.38403 18.7461 5.38403 20.6153C5.38403 22.4846 6.89938 23.9999 8.76865 23.9999Z"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M25.692 23.9999C27.5613 23.9999 29.0766 22.4846 29.0766 20.6153C29.0766 18.7461 27.5613 17.2307 25.692 17.2307C23.8227 17.2307 22.3074 18.7461 22.3074 20.6153C22.3074 22.4846 23.8227 23.9999 25.692 23.9999Z"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M5.38461 20.6154H2V10.4615M2 10.4615L5.38461 2H20.6154L27.3846 10.4615M2 10.4615H27.3846M27.3846 10.4615H29.0769C29.9746 10.4615 30.8354 10.8181 31.4702 11.4529C32.1049 12.0876 32.4615 12.9485 32.4615 13.8461V20.6154H29.0769M22.3077 20.6154H12.1538M17.2308 10.4615V2"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                            ...
                            <h3 className="mt-5 text-xl font-bold text-black dark:text-white">Pick & Drop Facility</h3>
                            <p className="mt-2.5 text-base font-medium leading-8">Lorem ipsum dolor sit amet consectetur adipiscing elit ugue quam diam.</p>
                        </div>
                        <div className="group rounded-2xl border-2 border-dashed border-gray-dark/20 bg-white p-[30px] pl-5 duration-200 hover:border-secondary hover:bg-secondary/20 dark:border-white/20 dark:bg-gray-dark dark:hover:bg-secondary/20">
                            <span className="flex h-[60px] w-[60px] items-center justify-center rounded-full bg-secondary/10 group-hover:bg-black">
                                <svg width="27" height="26" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M22.7059 7.17651H4.58824C3.15879 7.17651 2 8.33531 2 9.76475V21.4118C2 22.8413 3.15879 24.0001 4.58824 24.0001H22.7059C24.1353 24.0001 25.2941 22.8413 25.2941 21.4118V9.76475C25.2941 8.33531 24.1353 7.17651 22.7059 7.17651Z"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M18.8232 2L13.6467 7.17648L8.47021 2"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path d="M17.5293 7.17651V24.0001" stroke="#B476E5" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M21.4116 17.5293V17.5428" stroke="#B476E5" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M21.4116 13.647V13.6605" stroke="#B476E5" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </span>
                            <h3 className="mt-5 text-xl font-bold text-black dark:text-white">Smart TV</h3>
                            <p className="mt-2.5 text-base font-medium leading-8">Lorem ipsum dolor sit amet consectetur adipiscing elit ugue quam diam.</p>
                        </div>
                        <div className="group rounded-2xl border-2 border-dashed border-gray-dark/20 bg-white p-[30px] pl-5 duration-200 hover:border-secondary hover:bg-secondary/20 dark:border-white/20 dark:bg-gray-dark dark:hover:bg-secondary/20">
                            <span className="flex h-[60px] w-[60px] items-center justify-center rounded-full bg-secondary/10 group-hover:bg-black">
                                <svg width="36" height="20" viewBox="0 0 36 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M25.1097 5.55525C26.0914 5.55525 26.8873 4.75938 26.8873 3.77763C26.8873 2.79587 26.0914 2 25.1097 2C24.1279 2 23.332 2.79587 23.332 3.77763C23.332 4.75938 24.1279 5.55525 25.1097 5.55525Z"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M7.33203 7.33309L14.4425 3.77783L20.6642 9.11071L17.9978 12.666"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M2 17.5549C2.55336 17.83 3.15989 17.9817 3.77763 17.9993C4.47001 18.0138 5.15551 17.8595 5.77492 17.5498C6.39434 17.2401 6.92906 16.7843 7.33288 16.2217C7.7367 15.6591 8.27142 15.2032 8.89084 14.8935C9.51025 14.5838 10.1958 14.4295 10.8881 14.4441C11.5805 14.4295 12.266 14.5838 12.8854 14.8935C13.5049 15.2032 14.0396 15.6591 14.4434 16.2217C14.8472 16.7843 15.3819 17.2401 16.0013 17.5498C16.6208 17.8595 17.3063 18.0138 17.9986 17.9993C18.691 18.0138 19.3765 17.8595 19.9959 17.5498C20.6154 17.2401 21.1501 16.7843 21.5539 16.2217C21.9577 15.6591 22.4924 15.2032 23.1118 14.8935C23.7313 14.5838 24.4168 14.4295 25.1091 14.4441C25.8015 14.4295 26.487 14.5838 27.1064 14.8935C27.7259 15.2032 28.2606 15.6591 28.6644 16.2217C29.0682 16.7843 29.6029 17.2401 30.2224 17.5498C30.8418 17.8595 31.5273 18.0138 32.2197 17.9993C32.8374 17.9817 33.4439 17.83 33.9973 17.5549"
                                        stroke="#B476E5"
                                        strokeWidth="3"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                            ...
                            <h3 className="mt-5 text-xl font-bold text-black dark:text-white">Swimming Pool</h3>
                            <p className="mt-2.5 text-base font-medium leading-8">Lorem ipsum dolor sit amet consectetur adipiscing elit ugue quam diam.</p>
                        </div>
                    </div>
                    <div className="text-center">
                        <Link href="/services" className="btn mt-7 bg-secondary py-[18px] px-8 text-white">
                            More Services
                        </Link>
                    </div>
                </div>
            ...
            <section className="relative bg-[url(/assets/images/hotel-resort/counter-bg.jpg)] bg-cover bg-fixed bg-center bg-no-repeat after:absolute after:inset-0 after:bg-black/90">
                <div className="container">
                    <div
                        className="relative z-[1] grid grid-cols-2 gap-5 py-12 text-center sm:gap-7 md:grid-cols-4 lg:py-24"
                        data-aos="fade-up"
                        data-aos-duration="1000"
                    >
                        <div className="rounded-2xl bg-white/25 p-[5px]">
                            <div className="rounded-2xl bg-white py-10 dark:bg-black">
                                <CountUp className="text-[34px] font-black leading-[42px] text-gray" start={0} end={250} duration={4} suffix="+"></CountUp>
                                <p className="text-base font-bold text-black dark:text-white">Booking Month</p>
                            </div>
                        </div>
                        <div className="rounded-2xl bg-white/25 p-[5px]">
                            <div className="rounded-2xl bg-white py-10 dark:bg-black">
                                <CountUp className="text-[34px] font-black leading-[42px] text-gray" start={0} end={30} duration={4} suffix="+"></CountUp>
                                <p className="text-base font-bold text-black dark:text-white">Visitors daily</p>
                            </div>
                        </div>
                        <div className="rounded-2xl bg-white/25 p-[5px]">
                            <div className="rounded-2xl bg-white py-10 dark:bg-black">
                                <CountUp className="text-[34px] font-black leading-[42px] text-gray" start={0} end={98} duration={4} suffix="+"></CountUp>
                                <p className="text-base font-bold text-black dark:text-white">Positive feedback</p>
                            </div>
                        </div>
                        <div className="rounded-2xl bg-white/25 p-[5px]">
                            <div className="rounded-2xl bg-white py-10 dark:bg-black">
                                <CountUp className="text-[34px] font-black leading-[42px] text-gray" start={0} end={20} duration={4} suffix="+"></CountUp>
                                <p className="text-base font-bold text-black dark:text-white">Awards & honors</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-12 lg:py-24">
                <div className="container">
                    <div className="flex flex-col items-center justify-between sm:flex-row">
                        <div className="heading mb-8 text-center ltr:sm:text-left rtl:sm:text-right">
                            <h6>Destinations</h6>
                            <h4>NEAR NICE PLACES</h4>
                        </div>
                        <div>
                            <button type="button" className="btn mb-5 text-white sm:mb-0">
                                View all
                            </button>
                        </div>
                    </div>
                    <div
                        className="grid grid-cols-1 gap-y-12 gap-x-[30px] text-center sm:grid-cols-2 lg:grid-cols-3"
                        data-aos="fade-up"
                        data-aos-duration="1000"
                    >
                        <div className="group">
                            <div className="relative overflow-hidden rounded-[20px]">
                                <div className="absolute inset-0 z-[1] bg-gradient-to-b from-transparent to-[#08111F] opacity-0 transition duration-500 group-hover:inset-y-0 group-hover:opacity-70"></div>
                                <img src="/assets/images/hotel-resort/place1.jpg" className="scale-100 transition duration-500 group-hover:scale-110" alt="" />
                                <div className="absolute inset-5 bottom-auto z-[1] flex items-center justify-between">
                                    <span className="h-6 rounded-md bg-secondary px-2 text-[13px] leading-6 text-white hover:bg-primary"> Recommend </span>
                                    <p className="rounded-full bg-white py-2 px-4 text-base font-bold text-black">$ 189.99 USD</p>
                                </div>
                                <div className="item-center absolute bottom-5 right-5 z-[1] flex gap-2">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_1110_12876)">
                                            <path
                                                d="M12.0833 5.41669L14.5833 3.00002C14.9038 2.67955 15.3385 2.49951 15.7917 2.49951C16.2449 2.49951 16.6795 2.67955 17 3.00002C17.3205 3.32049 17.5005 3.75514 17.5005 4.20835C17.5005 4.66157 17.3205 5.09622 17 5.41669L14.5833 7.91669L16.6667 14.1667L14.5833 16.2917L11.6667 10.8334L9.16667 13.3334V15.8334L7.5 17.5L6.25 13.75L2.5 12.5L4.16667 10.8334H6.66667L9.16667 8.33335L3.75 5.41669L5.83333 3.33335L12.0833 5.41669Z"
                                                stroke="white"
                                                strokeWidth="1.5"
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                        ...
                                        <defs>
                                            <clipPath id="clip0_1110_12876">
                                                <rect width="20" height="20" fill="white" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                    <p className="text-sm font-bold text-white">05 Days</p>
                                </div>
                            </div>
                            <h2 className="mt-6">
                                <Link href="#" className="text-2xl font-bold text-black hover:text-primary dark:text-white">
                                    Paris Rail Day Trip
                                </Link>
                            </h2>
                            <p className="mt-2.5 text-lg font-normal">Lorem ipsum dolor sit amet dolor consectetur adipiscing elit</p>
                        </div>
                        <div className="group">
                            <div className="relative overflow-hidden rounded-[20px]">
                                <div className="absolute inset-0 z-[1] bg-gradient-to-b from-transparent to-[#08111F] opacity-0 transition duration-500 group-hover:inset-y-0 group-hover:opacity-70"></div>
                                <img src="/assets/images/hotel-resort/place2.jpg" className="scale-100 transition duration-500 group-hover:scale-110" alt="" />
                                <div className="absolute inset-5 bottom-auto z-[1] flex items-center justify-between">
                                    <span className="h-6 rounded-md bg-secondary px-2 text-[13px] leading-6 text-white hover:bg-primary"> Recommend </span>
                                    <p className="rounded-full bg-white py-2 px-4 text-base font-bold text-black">$ 160.99 USD</p>
                                </div>
                                <div className="item-center absolute bottom-5 right-5 z-[1] flex gap-2">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_1110_12876)">
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden rounded-[20px]">
                                <div className="absolute inset-0 z-[1] bg-gradient-to-b from-transparent to-[#08111F] opacity-0 transition duration-500 group-hover:inset-y-0 group-hover:opacity-70"></div>
                                <img src="/assets/images/hotel-resort/place3.jpg" className="scale-100 transition duration-500 group-hover:scale-110" alt="" />
                                <p className="absolute top-5 right-5 z-[1] rounded-full bg-white py-2 px-4 text-base font-bold text-black">$ 160.99 USD</p>
                                <div className="item-center absolute bottom-5 right-5 z-[1] flex gap-2">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_1110_12876)">
                                            <path
                                    ...
                                    <p className="text-sm font-bold text-white">08 Days</p>
                                </div>
                            </div>
                            <h2 className="mt-6">
                                <Link href="#" className="text-2xl font-bold text-black hover:text-primary dark:text-white">
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden rounded-[20px]">
                                <div className="absolute inset-0 z-[1] bg-gradient-to-b from-transparent to-[#08111F] opacity-0 transition duration-500 group-hover:inset-y-0 group-hover:opacity-70"></div>
                                <img src="/assets/images/hotel-resort/place4.jpg" className="scale-100 transition duration-500 group-hover:scale-110" alt="" />
                                <p className="absolute top-5 right-5 z-[1] rounded-full bg-white py-2 px-4 text-base font-bold text-black">$ 102.99 USD</p>
                                <div className="item-center absolute bottom-5 right-5 z-[1] flex gap-2">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_1110_12876)">
                                            <path
                                    ...
                                    <p className="text-sm font-bold text-white">03 Days</p>
                                </div>
                            </div>
                            <h2 className="mt-6">
                                <Link href="#" className="text-2xl font-bold text-black hover:text-primary dark:text-white">
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden rounded-[20px]">
                                <div className="absolute inset-0 z-[1] bg-gradient-to-b from-transparent to-[#08111F] opacity-0 transition duration-500 group-hover:inset-y-0 group-hover:opacity-70"></div>
                                <img src="/assets/images/hotel-resort/place5.jpg" className="scale-100 transition duration-500 group-hover:scale-110" alt="" />
                                <div className="absolute inset-5 bottom-auto z-[1] flex items-center justify-between">
                                    <span className="h-6 rounded-md bg-secondary px-2 text-[13px] leading-6 text-white hover:bg-primary"> Recommend </span>
                                    <p className="rounded-full bg-white py-2 px-4 text-base font-bold text-black">$ 190.99 USD</p>
                                </div>
                                <div className="item-center absolute bottom-5 right-5 z-[1] flex gap-2">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_1110_12876)">
                                    ...
                                    <p className="text-sm font-bold text-white">10 Days</p>
                                </div>
                            </div>
                            <h2 className="mt-6">
                                <Link href="#" className="text-2xl font-bold text-black hover:text-primary dark:text-white">
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden rounded-[20px]">
                                <div className="absolute inset-0 z-[1] bg-gradient-to-b from-transparent to-[#08111F] opacity-0 transition duration-500 group-hover:inset-y-0 group-hover:opacity-70"></div>
                                <img src="/assets/images/hotel-resort/place6.jpg" className="scale-100 transition duration-500 group-hover:scale-110" alt="" />
                                <p className="absolute top-5 right-5 z-[1] rounded-full bg-white py-2 px-4 text-base font-bold text-black">$ 160.99 USD</p>
                                <div className="item-center absolute bottom-5 right-5 z-[1] flex gap-2">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_1110_12876)">
                        ...
                        <div className="flex flex-col items-center gap-4 lg:flex-row">
                            <div className="flex-1 text-center ltr:md:text-left rtl:md:text-right">
                                <div className="heading mb-8">
                                    ...
                                    <h6 className="mt-[18px] !font-semibold !text-gray">
                                        Our objective at Plurk is to bring together our visitor's societies and spirits with our own, communicating enthusiasm
                                        and liberality in the food we share.
                                    </h6>
                                </div>
                                <div className="flex justify-center sm:gap-16 md:justify-start md:gap-10">
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3">
                                            ...
                                            <Link href="#" className="text-lg font-semibold text-white duration-200 hover:text-primary">
                                                Spa/gym
                                            </Link>
                                        </li>
                                        <li className="flex items-center gap-3">
                            ...
                            <div className="flex-1 overflow-hidden rounded-[25px]">
                                <img src="/assets/images/hotel-resort/whychooseus.jpg" className="xl:h-[500px]" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className=" mt-12 bg-white py-[50px] px-5 dark:bg-gray-dark lg:mt-24">
                <LogoSlider />
            </section>
            ...
            <section className="bg-gradient-to-t from-white/60 py-12 dark:bg-gradient-to-t dark:from-white/10 lg:py-24">
                <div className="container">
                    ...
                    <ul className="filters realestate-filter mt-7 flex flex-row gap-5 overflow-auto whitespace-nowrap pb-2.5 pl-1 sm:gap-[30px]">
                        ...
                        <li className={`filter ${activeTab === 'family-suit' ? 'active' : ''}`}>
                            <button
                                type="button"
                                className="btn rounded-xl bg-gray/[0.08] capitalize text-gray hover:bg-primary"
                    ...
                    <div className="projects mt-8 grid grid-cols-1 gap-[30px] sm:grid-cols-2 md:grid-cols-3" data-aos="fade-up" data-aos-duration="1000">
                        <div
                            className={`project group relative overflow-hidden rounded-xl ${
                                activeTab === 'cozy-room' || activeTab === 'delux-room' ? 'block' : 'hidden'
                            }`}
                        >
                            ...
                            <div className="absolute inset-0 m-auto flex scale-0 items-center justify-center text-white transition duration-700 group-hover:scale-100">
                                <Link
                                    ...
                                    onClick={() => {
                                        setIsOpen(true);
                                        setPhotoIndex(getItems().findIndex((d: string) => d.toLowerCase().includes('room1.jpg')));
                                    }}
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        >
                            ...
                            <div className="absolute inset-0 m-auto flex scale-0 items-center justify-center text-white transition duration-700 group-hover:scale-100">
                                <Link
                                    ...
                                    onClick={() => {
                                        setIsOpen(true);
                                        setPhotoIndex(getItems().findIndex((d: string) => d.toLowerCase().includes('room2.jpg')));
                                    }}
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div className={`project group relative overflow-hidden rounded-xl ${activeTab === 'cozy-room' ? 'block' : 'hidden'}`}>
                            ...
                            <div className="absolute inset-0 m-auto flex scale-0 items-center justify-center text-white transition duration-700 group-hover:scale-100">
                                <Link
                                    ...
                                    onClick={() => {
                                        setIsOpen(true);
                                        setPhotoIndex(getItems().findIndex((d: string) => d.toLowerCase().includes('room3.jpg')));
                                    }}
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div
                            className={`project group relative overflow-hidden rounded-xl ${
                                activeTab === 'cozy-room' || activeTab === 'family-suit' ? 'block' : 'hidden'
                            }`}
                        >
                            <div className="absolute inset-0 duration-200 group-hover:bg-black/50"></div>
                            <img src="/assets/images/hotel-resort/room4.jpg" className="z-[1] h-full w-full object-cover" alt="" />
                            <div className="absolute inset-0 m-auto flex scale-0 items-center justify-center text-white transition duration-700 group-hover:scale-100">
                                <Link
                                    href="#"
                                    scroll={false}
                                    ...
                                    onClick={() => {
                                        setIsOpen(true);
                                        setPhotoIndex(getItems().findIndex((d: string) => d.toLowerCase().includes('room4.jpg')));
                                    }}
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        >
                            <div className="absolute inset-0 duration-200 group-hover:bg-black/50"></div>
                            <img src="/assets/images/hotel-resort/room5.jpg" className="z-[1] h-full w-full object-cover" alt="" />
                            <div className="absolute inset-0 m-auto flex scale-0 items-center justify-center text-white transition duration-700 group-hover:scale-100">
                                <Link
                                    href="#"
                                    scroll={false}
                                    ...
                                    onClick={() => {
                                        setIsOpen(true);
                                        setPhotoIndex(getItems().findIndex((d: string) => d.toLowerCase().includes('room5.jpg')));
                                    }}
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div
                            className={`project group relative overflow-hidden rounded-xl ${
                                activeTab === 'cozy-room' || activeTab === 'modern-room' ? 'block' : 'hidden'
                            }`}
                        >
                            <div className="absolute inset-0 duration-200 group-hover:bg-black/50"></div>
                            <img src="/assets/images/hotel-resort/room6.jpg" className="z-[1] h-full w-full object-cover" alt="" />
                            <div className="absolute inset-0 m-auto flex scale-0 items-center justify-center text-white transition duration-700 group-hover:scale-100">
                                <Link
                                    href="#"
                                    scroll={false}
                                    ...
                                    onClick={() => {
                                        setIsOpen(true);
                                        setPhotoIndex(getItems().findIndex((d: string) => d.toLowerCase().includes('room6.jpg')));
                                    }}
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <Testimonial className="py-14 lg:py-[100px]"></Testimonial>

            <section className="relative bg-gradient-to-t from-white/60 py-12 dark:bg-[#F6F8FD]/10 dark:from-transparent lg:py-24">
                <div className="absolute bottom-0 max-w-[550px] opacity-10 ltr:left-0 rtl:right-0">
                    <img src="/assets/images/hotel-resort/news.png" className="h-full w-full object-cover" alt="" />
                </div>
                <div className="container">
                    <div className="flex flex-col justify-between md:flex-row">
                        <div className="heading text-center md:mb-10 ltr:md:text-left rtl:md:text-right">
                            <h4 className="mb-2 !text-primary">Latest News & Events</h4>
                            <h5 className="text-base font-semibold">Excepteur sint occaecat cupidatat non proident sunt in culpa qui</h5>
                        </div>
                        <div className="text-center">
                            <button type="button" className="btn !text-sm text-white">
                                View all
                            </button>
                        </div>
                    </div>
                    <div className="mt-8 flex flex-col gap-10 md:mt-0 lg:flex-row">
                        <div className="flex-1">
                            <div className="h-[243px] w-full overflow-hidden rounded-[20px]">
                                <img src="/assets/images/hotel-resort/news1.jpg" className="w-full" alt="" />
                            </div>
                            <div className="relative z-[1] mt-5 flex gap-4">
                                <div className="relative top-1/2 z-[1] flex h-[75px] w-[75px] flex-none flex-col items-center justify-center rounded-[10px] bg-black text-center text-white">
                                    <h3 className="text-[28px] font-extrabold leading-5">20</h3>
                                    <p className="text-xl font-extrabold">May</p>
                                </div>
                                <div>
                                    <h3 className="text-[22px] font-bold leading-7 text-black dark:text-white">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Link href="#">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="9" cy="4.5" r="3" stroke="#7780A1" strokeWidth="1.5" />
                                                    <path
                            ...
                            <p className="relative z-[1] mt-2.5 text-base font-medium">
                                Lorem ipsum dolor amet consectetur adipisicing elit sed eiusm tempor incididunt ut lab ore dolor magna aliqua enim ad minim
                                veniam quis nostrud exercitation ullamco. laboris nisi ut aliquip ex ea commodo.
                            </p>
                        </div>
                        <div className="flex-1 space-y-4">
                            <div className="group flex gap-3">
                                <div className="w-20 flex-none sm:w-[120px]">
                                    <div className="relative h-20 overflow-hidden rounded-[10px] sm:h-[120px]">
                                        <div className="absolute inset-0 flex scale-0 items-center justify-center bg-black/60 duration-500 group-hover:scale-100">
                                            <h5 className="text-[22px] font-extrabold text-white">
                                                22 <br />
                                                <span className="text-base font-extrabold">Jan</span>
                                            </h5>
                                        </div>
                                        <img src="/assets/images/hotel-resort/news2.jpg" className="h-full w-full object-cover" alt="" />
                                    </div>
                                </div>
                                <div>
                                    <h3 className="text-[22px] font-bold text-black duration-200 hover:text-primary dark:text-white dark:hover:text-primary">
                                        <Link href="#">Etiam Vel Neqe</Link>
                                    </h3>
                                    <p className="mt-2 text-base font-medium">
                                        Lorem ipsum dolor sit amet consectetur elit sed do. eiusm tempor incididunt labore et dolore magna aliqua ut enim ad
                                        minim veniam quis nostrud.
                                    </p>
                                </div>
                            </div>
                            <div className="border border-dashed border-gray opacity-50"></div>
                            <div className="group flex gap-3">
                                <div className="w-20 flex-none sm:w-[120px]">
                                    <div className="relative h-20 overflow-hidden rounded-[10px] sm:h-[120px]">
                                        <div className="absolute inset-0 flex scale-0 items-center justify-center bg-black/60 duration-500 group-hover:scale-100">
                                        ...
                                        <img src="/assets/images/hotel-resort/news3.jpg" className="h-full w-full object-cover" alt="" />
                                    </div>
                                </div>
                                <div>
                                    <h3 className="text-[22px] font-bold text-black duration-200 hover:text-primary dark:text-white dark:hover:text-primary">
                            ...
                            <div className="group flex gap-3">
                                <div className="w-20 flex-none sm:w-[120px]">
                                    <div className="relative h-20 overflow-hidden rounded-[10px] sm:h-[120px]">
                                        ...
                                        <img src="/assets/images/hotel-resort/news4.jpg" className="h-full w-full object-cover" alt="" />
                                    </div>
                                </div>
                                <div>
                                    <h3 className="text-[22px] font-bold text-black duration-200 hover:text-primary dark:text-white dark:hover:text-primary">
                ...
                <div className="container">
                    <div className="relative z-10 lg:flex">
                        <div className="heading text-center lg:mb-0 lg:w-1/3 ltr:lg:pr-10 ltr:lg:text-left rtl:lg:pl-10 rtl:lg:text-right">
                            ...
                            <div className="mx-auto mt-5 max-w-[330px] overflow-hidden" data-aos="fade-right" data-aos-duration="1000">
                                <img src="/assets/images/hotel-resort/frame.svg" alt="" className="w-full" />
                            </div>
                        </div>
